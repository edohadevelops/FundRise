...
const LikedCampaigns = () => {
  ...
  return (
    <div className='liked-campaigns-page'>
        <div className="liked-campaigns-header">
            <button className='liked-campaigns-back' onClick={()=>history.back()}>
                <img src={ArrowBack} alt="" />
            </button>
            <p>Liked Campaigns</p>
        </div>
        <div className="liked-campaigns-content">
        {
            campaigns.length === 0 ?
